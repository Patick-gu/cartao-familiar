...
<div class="d-sm-flex align-items-center justify-content-end mb-4">
    <?php if (SessionValidator::isAdmin()) : ?>
        <a href="parceiros/cadastro" class="d-none d-sm-inline-block btn btn-md btn-primary shadow-sm"><i class="fas fa-users fa-sm text-white-50"></i> Novo Parceiro</a>
    <?php endif; ?>
</div>
                ...
                <tbody>
                    <?php foreach ($partners as $partner) : ?>
                        <tr>
                            ...
                            <td><?= $partner['email']; ?></td>
                            <td>
                                <a href="parceiros/cadastro/<?= $partner['partner_id']; ?>" class="btn btn-warning btn-sm">Editar <i class="fas fa-pencil-alt"></i></a>
                                <a href="#" data-id="<?= $partner['partner_id']; ?>" class="btn btn-danger btn-sm delete-partner">Excluir <i class="fas fa-times"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
