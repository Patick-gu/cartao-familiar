 ...
 <div class="d-sm-flex align-items-center justify-content-end mb-4">
     <?php if (SessionValidator::isAdmin()) : ?>
         <a href="usuarios/cadastro" class="d-none d-sm-inline-block btn btn-md btn-primary shadow-sm"><i class="fas fa-users fa-sm text-white-50"></i> Novo Usuário</a>
     <?php endif; ?>
 </div>
                 ...
                 <tbody>
                     <?php foreach ($users as $user) : ?>
                         <tr>
                             ...
                             <td><?= $user['email']; ?></td>
                             <td><?= Helper::datetoBR($user['dt_login']); ?></td>
                             <td>
                                 <a href="usuarios/cadastro/<?= $user['user_id']; ?>" class="btn btn-warning btn-sm">Editar <i class="fas fa-pencil-alt"></i></a>
                                 <a href="#" data-id="<?= $user['user_id']; ?>" class="btn btn-danger btn-sm delete-user">Excluir <i class="fas fa-times"></i></a>
                             </td>
                         </tr>
                     <?php endforeach; ?>
                 </tbody>
